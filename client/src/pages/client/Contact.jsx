...
const Contact = () => {
  ...
  return (
    <section className="bg-linear-to-b from-base-100/80 via-base-200/40 to-base-100/80 min-h-screen w-full px-4 pt-6 pb-16 space-y-12 flex flex-col items-center justify-center overflow-x-hidden">
      ...
      <aside className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 rounded-3xl bg-base-200 p-8 md:p-12 shadow-sm">
        ...
        {/* Left: Contact Info */}
        <ScrollReveal animation="slideRight" delay={0.3} className="space-y-8">
        ...
        {/* Right: Google Map */}
        <ScrollReveal animation="slideLeft" delay={0.4} className="w-full h-full">
          <div className="w-full h-full">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3764.835975644133!2d125.12704766527348!3d8.102311583524124!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32ff01c35c7fae59%3A0x9b3fbb15fcd96554!2sHJ%20Wedding%20%26%20Events%20Gownshop!5e1!3m2!1sen!2sph!4v1765255638923!5m2!1sen!2sph"
